...
namespace Mariojgt\Canvas\Commands;
...
class Republish extends Command
{
     ...
     * @var string
     */
    protected $signature = 'republish:canvas';
    ...
    public function handle()
    {
        ...
        $targetFolderResource = resource_path('vendor/Canvas/');
        ...
        $targetFolderPublic = public_path('vendor/Canvas/');
