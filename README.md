![image info](https://raw.githubusercontent.com/mariojgt/canvas/master/Publish/Public/image/canvas.png)
...
1. composer require mariojgt/canvas
...
1. git clone https://github.com/mariojgt/canvas
...
3. ```javascript
   "repositories": [
           {
               "type" : "path",
               "url": "packages/canvas", // Path to your local folder package
               "options": {
                   "symlink": true
               }
           }
       ...
       "require": {
           ...
           "mariojgt/canvas": "@dev"// Here is where you add the package reference
       },
   ```
...
This package purpose is to give a fresh start for a new package so you can use those premade tools or just delete and use the package canvas.
